// URL de la API (en Vercel será /api/lecturas)
const API_URL = import.meta.env.VITE_API_URL || '/api/lecturas';
...
export const migrarDatosIniciales = async () => {
  try {
    ...
    const datosIniciales = {
      ...
      resumen: {
        datos: [
          { apto: '202', consumo: 78, valorEnergia: 63933.48, aseo: 29142, total: 93075.48 },
          { apto: '203', consumo: 200, valorEnergia: 163932, aseo: 29142, total: 193074 },
          { apto: '301', consumo: 109.6, valorEnergia: 89834.74, aseo: 29142, total: 118976.74 },
          { apto: '302', consumo: 149.8, valorEnergia: 122785.07, aseo: 29142, total: 151927.07 },
          { apto: '201', consumo: 78.6, valorEnergia: 64425.28, aseo: 29142, total: 93567.28 }
        ],
